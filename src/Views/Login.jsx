      ...
      >
        <div className="login-form">
          ...
          <Button
            ...
            onClick={() => {
              window.location.href = `https://accounts.spotify.com/authorize?client_id=${process.env.REACT_APP_CLIENT_ID}&response_type=token&scope=user-top-read%20user-library-read%20user-read-recently-played&redirect_uri=${process.env.REACT_APP_REDIRECT_URI}`;
            }}
          >
